...
gas.set_equivalence_ratio(phi=1.0, fuel="C2H4", oxidizer="O2:1, N2:3.76")
gas.TP = 2500, 101325  # temperature [K], pressure [Pa]
...
plt.figure()
plt.plot(time, iterations_cgt, color=colors["orange"],linestyle = '--', label = "Temperature Formulation")
plt.plot(time, iterations_cgc, color=colors["red"], linestyle = '-.', label = "Conservative Formulation")
plt.legend()

plt.figure()
plt.plot(time, newt_iterations_cgt, color=colors["orange"],linestyle = '--', label = "Temperature Formulation")
plt.plot(time, newt_iterations_cgc, color=colors["red"], linestyle = '-.', label = "Conservative Formulation")
plt.legend()
plt.show()
