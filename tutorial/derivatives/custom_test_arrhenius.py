...
template <typename Func>
void derivative_checker(Func function,  {scalar_parameter} x_test, {scalar_parameter} starting_dx, {index} n_refine)
{{
    for({index} i = 0; i < n_refine; i++)
    {{
        {scalar} dx = starting_dx * std::pow({scalar_cast}(0.5), {scalar_cast}(i));

        {scalar} df_dx = finite_difference(function, x_test, dx);
        std::cout << df_dx <<" ";
    }}
    std::cout<<std::endl;
}}
...
//test generic expression
    ...
    derivative_checker(my_function_0, x_test, 2.0, 10);
    std::cout << std::endl;
...
//exp gen
    ...
    derivative_checker(my_function_0a, x_test, 2.0, 10);
    std::cout << std::endl;
...
//test exponent in arrhenius
    ...
    derivative_checker(my_function_1, x_test, 10.0 , 5);
    std::cout << std::endl;
...
//test arrhenius
    ...
    derivative_checker(my_function, x_test, 10.0 , 5);
    std::cout << std::endl;
...
//test arrhenius
    ...
    derivative_checker(my_function_4, x_test, 10.0 , 5);
    std::cout << std::endl;
...
//test arrhenius
    ...
    derivative_checker(my_function_5, x_test, log_gen(5.0) , 10);
    std::cout << std::endl;
